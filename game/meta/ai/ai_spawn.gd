@tool
class_name AISpawn extends Node3D

@export var shell: Resource = null
@export var possession: Resource = null
...
func _spawn():
	...
	instance.get_node("Character").add_child(possession.instantiate())
