...
class Generator extends EnvironmentObjectSource.Generator:
	...
	func generate(params: EnvironmentObjectSource.GeneratorParams) -> EnvironmentObjectSource.GeneratorResult:
		...
		var result = EnvironmentObjectSource.GeneratorResult.new()
		result.node = root
